...
public partial record struct MenuButton
{
    ...
    public readonly (Response, InnerResponse<R>?) Ui<R>(Ui ui, Func<Ui, R> addContents)
    {
        ...
        var (response, maybeInner) = EguiMarshal.Call<nuint, MenuButton, EguiCallback, (Response, Response?)>(EguiFn.egui_containers_menu_MenuButton_ui, ui.Ptr, this, callback.AsNative());
