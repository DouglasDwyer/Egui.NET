...
- egui-rs - a vendored [subtree](https://git-scm.com/book/en/v2/Git-Tools-Advanced-Merging#_subtree_merge) of `egui`, with the C# interop changes described below
...
- egui_plot-rs - a vendored subtree of [`egui_plot`](https://github.com/emilk/egui_plot), with the C# interop changes described below
