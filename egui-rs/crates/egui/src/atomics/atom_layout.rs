...
impl AtomLayout {
    ...
    /// [`Ui::available_size`].
    pub fn measure(self, ui: &Ui, available_size: Vec2) -> SizedAtomLayout {
        let Self {
            id,
            mut atoms,
            gap,
...
pub struct AllocatedAtomLayout {
    /// The measured layout.
    pub sized: SizedAtomLayout,

    pub response: Response,
}

impl SizedAtomLayout {
...
impl Deref for SizedAtomLayout {
...
impl DerefMut for SizedAtomLayout {
    fn deref_mut(&mut self) -> &mut Self::Target {
