...
pub trait AtomExt {
    ...
    fn atom_size(self, size: Vec2) -> Atom;
    ...
    /// remaining space.
    fn atom_grow(self, grow: bool) -> Atom;
    ...
    fn atom_shrink(self, shrink: bool) -> Atom;
    ...
    fn atom_align(self, align: emath::Align2) -> Atom;
}

impl<T> AtomExt for T
where
    T: Into<Atom> + Sized,
{
    fn atom_id(self, id: Id) -> Atom {
