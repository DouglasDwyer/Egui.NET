        ...
        S: serde::Serializer,
    {
        unsafe {
            response_serde_helper::Response {
                ...
                sense: self.sense,
                interact_pointer_pos_or_nan: self.interact_pointer_pos_or_nan,
                intrinsic_size_or_nan: self.intrinsic_size_or_nan,
                flags: self.flags,
            }
        ...
        unsafe {
            ...
            if inner.ctx < 8 {
                Ok(Self {
                    ...
                    sense: inner.sense,
                    interact_pointer_pos_or_nan: inner.interact_pointer_pos_or_nan,
                    intrinsic_size_or_nan: inner.intrinsic_size_or_nan,
                    flags: inner.flags,
                })
            } else {
                Ok(Self {
