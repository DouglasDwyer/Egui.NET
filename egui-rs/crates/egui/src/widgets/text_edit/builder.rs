...
pub struct TextEdit<'t> {
    ...
    pub layouter: Option<LayouterFn<'t>>,
    pub password: bool,
...
impl<'t> TextEdit<'t> {
    ...
    /// ```
    #[inline]
    pub fn hint_text(mut self, hint_text: impl IntoAtoms) -> Self {
    ...
    #[inline]
    pub fn prefix(mut self, prefix: impl IntoAtoms) -> Self {
    ...
    #[inline]
    pub fn suffix(mut self, suffix: impl IntoAtoms) -> Self {
