...
impl Button {
    ...
    #[inline]
    pub fn shortcut_text(mut self, shortcut_text: impl IntoAtoms) -> Self {
    ...
    #[inline]
    pub fn left_text(mut self, left_text: impl IntoAtoms) -> Self {
    ...
    #[inline]
    pub fn right_text(mut self, right_text: impl IntoAtoms) -> Self {
        self.layout.push_right(Atom::grow());
